...
session.findById("wnd[2]/usr/ctxtDY_PATH").text = "C:\Users\wu3y\Documents\pbot\process\pb1_medidas"
session.findById("wnd[2]").sendVKey 0
session.findById("wnd[2]/usr/ctxtDY_FILENAME").text = "200.idata.txt"
session.findById("wnd[2]").sendVKey 0
session.findById("wnd[1]/tbar[0]/btn[8]").press
session.findById("wnd[0]/tbar[1]/btn[8]").press
session.findById("wnd[0]/mbar/menu[0]/menu[11]/menu[2]").select
session.findById("wnd[1]/tbar[0]/btn[0]").press
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "C:\Users\wu3y\Documents\pbot\process\pb1_medidas"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "200.odata.txt"
session.findById("wnd[1]/tbar[0]/btn[0]").press
